...
export const HomeDirectorPrograma = () => {
    return (
        <div className="container mt-4 home-docente-content">
            <h3>Bienvenido Decano al Sistema de Gestión de Agenda Docente</h3>
                        ...
                        <div className="d-sm-flex align-items-center justify-content-between">
                            <div className="col-md p-3">
                                <p>
                                    ...
                                    Como <strong>Decano </strong>, puedes revisar las agendas enviadas, aprobar o rechazar las solicitudes de los docentes, y descargar informes detallados de las actividades programadas.
                                </p>
                                <p>
